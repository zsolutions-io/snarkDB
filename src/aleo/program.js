...
export const struct_to_code = (struct) => {
...
export const record_to_code = (record) => {
...
export const mapping_to_code = (mapping) => {
  return (
...
export const closure_to_code = (closure) => {
  return function_like_block_to_code("closure", closure);
}


export const function_to_code = (fct) => {
  return function_like_block_to_code("function", fct);
}


export const finalize_to_code = (finalize) => {
